...
extern int darkGray(const int width, const int height, unsigned char * inputImage, unsigned char ** darkGrayImage);
...
int main(int argc, char *argv[]) {
	...
	cout << "D\n";
	r=darkGray(inputImage.width(), inputImage.height(), inputImage.data(), &(darkGrayImage._data));
	if(r==1){
		cout << "ERRR\n";
		return 1;
	}
