...
extern int darkGray(const int width, const int height, const unsigned char * inputImage, unsigned char * darkGrayImage, int pxPerThr);
...
int main(int argc, char *argv[]) {
	...
	//cout << "Good\n";
	// Save output
	darkGrayImage.save(("./" + string(argv[1]) + ".dark.try.par.bmp").c_str());
